...
def main(dataset_name, net_name, xp_path, data_path, load_config, load_model, objective, nu, device, seed,
    ...
    if pretrain:
        ...
        logger.info('Reconstruction loss at pre-training time: {}'.format( deep_SVDD.reconstruction_loss(dataset,cfg.settings['ae_batch_size'],n_jobs_dataloader,'cuda')))
    ...
    if retrain_decoder:
        deep_SVDD.retrain_decoder(dataset,
                           ...
                           device=device,
                           n_jobs_dataloader=n_jobs_dataloader)
        logger.info('Reconstruction loss at retraining time: {}'.format(deep_SVDD.reconstruction_loss(dataset,cfg.settings['ae_batch_size'],n_jobs_dataloader,'cuda')))
